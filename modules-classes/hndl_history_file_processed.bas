Attribute VB_Name = "hndl_history_file_processed"
Option Explicit
...
Public Function save_record()
    ...
    Set rg = next_row()
    rg.Offset(0, db_history_file_processed.INT_DATA_COL_OFFSET_NAME).Value = obj_file_record.str_name
    rg.Offset(0, db_history_file_processed.INT_DATA_COL_OFFSET_TRANSACTION_STARTED).Value = obj_file_record.str_date_started
    rg.Offset(0, db_history_file_processed.INT_DATA_COL_OFFSET_TRANSACTION_FINISHED).Value = obj_file_record.str_date_finished
    On Error GoTo 0
    Exit Function
ERR_FULL_SHEET:
